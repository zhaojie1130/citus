						  ...
						  RelationRestrictionContext *relationRestrictionContext)
{
	...
	/*
	 * We seed the common equivalence class with a randomly chosen distributed
	 * distributed table since we always want the input distributed relations
	 * to be on the common class.
	 */
